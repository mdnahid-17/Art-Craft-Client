...
export default function ArtDetails() {
  ...
  const { _id,name, price, rating, time, category, photo, customization, stock, description } = data || {};
  if (loader) {
  ...
  return (
    <div className="container my-[100px] mb-5 lg:my-[70px] lg:pt-1 flex flex-col justify-center items-center">
      ...
      <div className="rounded-[5px] border border-neutral-200 p-[15px] md:p-[20px] lg:p-[30px] mt-2 md:mt-8">
        <img className="w-full object-cover h-auto md:w-full md:h-full lg:w-full lg:h-[450px] rounded-[5px]" src={photo} />
